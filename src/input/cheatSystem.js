      ...
      <div class="config-modal__body cheat-dialog__body">
        ...
        <div class="config-modal__section cheat-dialog__help">
          ...
          <ul>
            ...
            <li title="Supported unit types include all ground, air, and naval units such as destroyer, hovercraft, vehicleFerry, aircraftCarrier, navalMineLayer, battleship, and submarine"><code>[type] [amount] [party]</code> - Spawn units around the cursor. Defaults to the player's party</li>
