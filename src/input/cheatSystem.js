      ...
      <div class="config-modal__body cheat-dialog__body">
        ...
        <div class="config-modal__section cheat-dialog__help">
          ...
          <ul>
            ...
            <li title="Supported unit types: harvester, tank_v1, tank-v2, tank-v3, rocketTank, recoveryTank, ambulance, tankerTruck, ammunitionTruck, apache, howitzer, mineLayer, mineSweeper, f22Raptor, f35, destroyer, supplyShip"><code>[type] [amount] [party]</code> - Spawn units around the cursor. Defaults to the player's party</li>
