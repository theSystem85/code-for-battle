...
export class TextureManager {
  ...
  selectCrystalBiomeUnderlayTile(tileX, tileY) {
    const biomeTag = ['soil', 'sand', 'grass', 'snow'].includes(this.integratedBiomeTag) ? this.integratedBiomeTag : 'grass'
    return this.selectIntegratedTileByTags(
      [biomeTag, 'passable'],
      tileX,
      tileY,
      ['decorative', 'impassable', 'ore', 'red']
    ) || this.selectIntegratedTileByTags(
      [biomeTag],
      tileX,
      tileY,
