...
export function updateUnitPosition(unit, mapGrid, occupancyMap, now, units = [], gameState = globalGameState, factories = null) {
  ...
  const isApache = unit.type === 'apache' || unit.type === 'f22'
  ...
  if (!(unit.type === 'tank' || unit.type === 'tank_v1' || unit.type === 'tank-v2' || unit.type === 'tank-v3' || unit.type === 'rocketTank' || unit.type === 'howitzer' || unit.type === 'apache' || unit.type === 'f22')) {
