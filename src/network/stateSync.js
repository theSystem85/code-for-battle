...
export function createGameStateSnapshot() {
  ...
  const units = (mainUnits || []).map(unit => ({
    ...
    embarkedUnitTypes: unit.embarkedUnitTypes,
    pendingLoadUnitId: unit.pendingLoadUnitId,
    pendingLoadUnitIds: unit.pendingLoadUnitIds,
    pendingUnloadTile: unit.pendingUnloadTile,
    transportOperation: unit.transportOperation,
    transportTransfer: unit.transportTransfer,
    ...
    selectedTurret: unit.selectedTurret,
    turretDamageOrder: unit.turretDamageOrder,
    batteries: unit.batteries,
    lastHullTargetId: unit.lastHullTargetId,
    broadsideStartedAt: unit.broadsideStartedAt,
    broadsideReloadUntil: unit.broadsideReloadUntil,
