...
8. **Animated Water Without Tile Asset Frames**
   ...
   - Water SOT overlays must avoid visible phase seams against adjacent full-water tiles; corner wedges should sample a neighboring water phase anchor so SOT and full water read as one continuous surface.
