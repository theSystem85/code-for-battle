...
8. **Animated Water Without Tile Asset Frames**
   ...
   - Ensure water SOT corner overlays render with padded/floored bounds so no visible seam lines appear where SOT triangles meet adjacent full-water tiles in the canvas renderer.
