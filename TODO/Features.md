...
- [x] Shoreline smoothing mesh (2026-04-08): trace land/water borders with marching-squares segments, render feathered shoreline strips post-terrain, cache/rebuild mesh per chunk on local tile mutation, and expose a debug overlay for shoreline lines/triangles.
- [x] Shoreline visual polish follow-up (2026-04-08): replaced contour-crossing shoreline strips with one-sided land-edge feather strips to remove diamond/chain artifacts and produce cleaner professional coast blending.
- [x] Shoreline blending follow-up (2026-04-08): switched shoreline pass to alpha-masked water-texture blending, integrated SOT-based rounded corner masks, and removed flat white-only shoreline appearance.
