- [x] SSE Version B animation workflow (2026-04-15): added Static/Animated tabs, animation-sheet source list from `public/images/map/animations`, per-tag frame-sequence labels, loop/play preview tied to selected tag, and instant runtime apply for destruction animation metadata.
