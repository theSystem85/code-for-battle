...
- [x] Street default tagged-sheet routing + SOT suppression (2026-04-23): defaulted street rendering to `streets23_q90_1024x1024.webp` with directional (`top/bottom/left/right`) best-match selection plus biome-aware preference (`grass/soil/snow/sand`), added the sheet to SSE/default selector indexes, and disabled SOT drawing on street-host tiles.
