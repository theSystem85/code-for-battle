- [x] Biome-aware decorative map tiles (2026-09-22): hybrid per-biome + `universal` DT sprite sheets (WebP 85%, seasons/group tags, winter lakes impassable), default integrated placement by `tile.biome`, organic DT retained, cliffs/boulders unchanged, skill at `skills/map-assets/SKILL.md`, packer `scripts/pack-biome-decorative-tiles.mjs`, spec `specs/087-map-decorative-tiles-research.md`.
