- [x] SSE grouped rectangular tile clusters (2026-04-19): added `group` paint mode with auto-incrementing `group_X` IDs and sidebar Group ID input (1-999), plus integrated runtime grouped placement for rocks/decorative tiles and footprint-sized debris group matching with 1x1 fallback.
