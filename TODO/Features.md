...
- [x] ✅ Unit ownership readability: render a party-colored (33% opacity) center circle (3px radius) on every unit sprite, rotating with the unit body so ownership is visible in-world (not HUD).
