- [ ] Biome-aware decorative map tiles (research 2026-09-22; **do not implement until questions answered**): biome-independent + biome-dependent DT; per-biome SSE sheets with lazy load; photorealistic ~65°/~300 m props at footprints 1×1–3×3 (incl. 2×1/1×2/2×3/3×2); seasonal trees/forests, winter/summer lakes, biome rocks; SSE tag + map-gen integration; new map-asset skill. Analysis: `specs/087-map-decorative-tiles-research.md`.
...
- [x] Jet fuel / ground recovery (2026-09-19): F22 and F35 return home with enough fuel for the inbound leg, refuse takeoff/attack orders that cannot complete a round trip, emergency-land with the existing landing animation plus a player notification, can be refilled by tanker trucks on the ground, and must be towed onto a street by a recovery tank before they can take off again. S releases any mounted unit.
...
- [x] Jet fuel / ground recovery (2026-09-19): F22 and F35 return home with enough fuel for the inbound leg, refuse takeoff/attack orders that cannot complete a round trip, emergency-land with the existing landing animation plus a player notification, can be refilled by tanker trucks on the ground, and must be towed onto a street by a recovery tank before they can take off again.
...
## 2026-08-30 Save editor visual design
