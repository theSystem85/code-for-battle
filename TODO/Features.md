- [ ] Jet fuel / ground recovery (2026-09-19): F22 and F35 return home with enough fuel for the inbound leg, refuse takeoff/attack orders that cannot complete a round trip, emergency-land with the existing landing animation plus a player notification, can be refilled by tanker trucks on the ground, and must be towed onto a street by a recovery tank before they can take off again. S releases any mounted unit.
