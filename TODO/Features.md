- [x] SSE deterministic 4-bit road autotile mask generator (2026-04-22): integrated a reusable road autotile generator into Sprite Sheet Editor with strict TRBL bitmask mapping (16 unique patterns), configurable tile/sheet/road/fade/smoothing controls, in-editor debug overlay + tile inspector, deterministic validation checks, and 1024x1024 PNG/WebP export from the editor workflow.
