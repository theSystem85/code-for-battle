- [x] Street sprite-sheet connectivity rendering (2026-04-23): integrated street tiles now default to `streets23_q90_1024x1024.webp` availability in Map Settings/SSE selectors, choose street variants by valid neighbor-direction tags (`top/bottom/left/right`) with best-match scoring, prefer matching biome-tagged street variants when present, and disable SOT mask rendering on street host tiles.
