- [ ] Programmable units (2026-09-25): units become player-programmable through a visual drag-and-drop block builder (no code). Policies cover conditional triggers and persistent state rules, can be toggled at runtime, and share one behavior engine with enemy AI (entry point differs). Starting spec: `docs/programmable-units-feature-list.md`.
