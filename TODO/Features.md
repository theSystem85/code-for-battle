- [x] SSE deterministic 4-bit road autotile mask generator (2026-04-22): integrated a reusable TRBL 4-bit mask generator into the Sprite Sheet Editor with in-editor controls (tile/grid/road width/fade/corner), live preview + tile inspector overlays, click-to-inspect connectivity, validation checks (16 unique patterns, border-center edge correctness, exact 1024x1024 export bounds), and PNG/WebP export plus “use as active sheet” workflow.
