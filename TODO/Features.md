...
- [x] ✅ Unit ownership readability: render a party-colored (50% opacity) center cross on every unit sprite, rotating with the unit body so ownership is visible in-world (not HUD).
