- [x] ✅ Rocket turret anti-air tuning (2026-03-20): rocket turret explosions now apply a 1.5x Apache-specific damage bonus so three direct rockets are enough to destroy an airborne Apache, with regression coverage in unit + Playwright E2E tests.
