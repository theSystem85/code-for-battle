...
## Bugs
- [x] Streets/walls build-area restriction (2026-03-19): placed streets and concrete walls no longer extend buildable range for other building types, but each still chains placement for additional copies of its own type.
