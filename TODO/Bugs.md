## Bugs
- [x] Fix forced defense-target commands so rocket/artillery turrets fire at commanded enemy targets (not just aim), and prioritize direct enemy target capture on force-attack clicks.
