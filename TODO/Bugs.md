...
- [x] **Portrait remote-control joysticks (2026-09-26)** — phone portrait now shows the virtual sticks above the action buttons, clear of the build bar and safe-area insets, and keeps movement, aim, fire, and release working across rotation. Landscape and desktop placement stay the same.
  - Spec: [Advanced Unit Control](../specs/004-advanced-unit-control/spec.md)
