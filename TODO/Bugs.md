## Bugs
- [x] Follow-up: fix iOS portrait PWA initial-load bottom safe-area gap by resolving safe-area CSS vars without waiting for touch-class and by running an additional delayed safe-area sync pass.
