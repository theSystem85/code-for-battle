...
## Bugs
- [x] Apache rockets now fly straight toward the initially aimed impact point instead of retargeting mid-flight, and airborne direct hits only land when the aircraft remains at that impact point; added E2E regression coverage.
