- [x] Water SOT seam fix (2026-03-25): removed visible diagonal edges between water corner smoothening overlays and full water tiles by applying consistent padded/floored SOT draw bounds so water renders as one continuous surface.
