- [x] Water SOT/full-water seam fix (2026-03-25): procedural water animation time is now sampled once per render pass and reused for both full water tiles and water SOT overlays, removing per-tile time drift that caused visible edges between diagonal SOT wedges and adjacent full water.
