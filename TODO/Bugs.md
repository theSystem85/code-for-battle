...
## Bugs
- [x] Water SOT/full-water seam cleanup (2026-03-25): water SOT overlays now sample procedural water animation phase from the adjacent diagonal water tile that owns the smoothed corner, eliminating visible seam lines between SOT wedges and neighboring full water tiles so shore transitions read as one continuous water surface.
