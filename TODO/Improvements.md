...
- [x] **Landing gallery balance and demo framing (2026-09-25)** — stack the desktop and landscape shots so the landscape card is not stretched under the portrait, and recapture the demo battle with a readable coast, cliffs, and grass-to-sand ground instead of street strips.
