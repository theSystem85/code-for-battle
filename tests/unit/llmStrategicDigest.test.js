...
describe('llmStrategicDigest', () => {
  it('replaces raw snapshot arrays with grouped strategic sections', () => {
    ...
    expect(digest.techTreeCsv).toContain('fmt:k,type,cost,req,extra')
    expect(digest.techTreeCsv).toContain('B,ammunitionFactory')
    expect(digest.techTreeCsv).toContain('U,howitzer')
