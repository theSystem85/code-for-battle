...
Grok 4.7, Cursor cloud agent (Grok 4.7). Token counts and reasoning-token totals were not exposed by this harness, so they are omitted. Wall time was still running when this note was written.
